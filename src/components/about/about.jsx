      ...
      <div className="about-wrapper">
        ...
        <div className="about">
          ...
          <p>
            ...
            something I tend to do at everything that I do in life. In my spare
            time I'm usually building things and searching for new skills to
            learn. I also speak Spanish, enjoy watching movies and traveling to
            exciting places.
          </p>
        </div>
      </div>
